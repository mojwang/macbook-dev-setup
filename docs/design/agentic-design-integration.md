...
The designer is one of 6 agents in `.claude/agents/` (product, researcher, planner, implementer, reviewer, designer). It produces design artifacts; engineering agents consume them.
